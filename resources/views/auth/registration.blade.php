        ...
        <div class="block xl:grid grid-cols-2 gap-4">
            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                ...
                <div class="my-auto">
                    ...
                    <div class="-intro-x mt-5 text-lg text-white text-opacity-70 dark:text-slate-400 lg:ml-10">Manage all
                        your <span class="font-bold"> Data </span> in one place</div>
                </div>
            </div>
            <!-- END: Login Info -->
            <!-- BEGIN: Login Form -->
            <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
                <div
                    ...
                    <div class="intro-x mt-2 text-slate-400 xl:hidden text-center">A few more clicks to sign in to your
                        account. Manage all your <span class="font-bold">Data</span> accounts in one place</div>
                    <div class="intro-x mt-8">
                        <form action="/register" method="POST">
                            @csrf
                            <input type="text" class="intro-x rounded-lg focus:rounded-xl focus:drop-shadow-lg login__input form-control py-3 px-4 block"
                                placeholder="Full name">
                            <input type="text" class="intro-x rounded-lg focus:rounded-xl focus:drop-shadow-lg login__input form-control py-3 px-4 block mt-4"
                                placeholder="NIK">
                            <input type="text" class="intro-x rounded-lg focus:rounded-xl focus:drop-shadow-lg login__input form-control py-3 px-4 block mt-4"
